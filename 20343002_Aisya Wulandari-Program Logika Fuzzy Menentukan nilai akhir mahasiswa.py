...
class fuzzyNilai: #Membuat Class FuzzyNilai untuk program Menentukan nilai Akhir Mahasiswa
    ...
    def controlSystem(self):#Membuat fungsi untuk penginputan nilai mahasiswa
        ...
        self.scoring.input['Forum'] = 9 #Menginputkan nilai Forum mahasiswa
        self.scoring.input['Disiplin'] = 9 #Menginputkan nilai Disiplin mahasiswa
        self.scoring.input['Nilai_Quiz'] = 9.4 #Menginputkan nilai Nilai_Quiz mahasiswa
